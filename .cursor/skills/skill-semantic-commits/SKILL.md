---
name: skill-semantic-commits
description: Propose Conventional Commit messages and commit groups from changed files. Use when grouping changes and writing commit messages.
---

# Semantic Commits (Single-line) + Change Grouping
